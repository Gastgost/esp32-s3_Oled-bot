...
async def handle_image(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        image = image.convert('1')  # Монохром
        ...
        await update.message.reply_photo(
            ...
            caption="✅ Вот как это будет выглядеть на OLED дисплее!\n\n"
                   ...
                   f"`{hex_array[:100]}...`\n\n"
                   "Полный код в следующем сообщении..."
        )
        
        # Отправляем полный массив
        await update.message.reply_text(f"`{hex_array}`", parse_mode='MarkdownV2')
